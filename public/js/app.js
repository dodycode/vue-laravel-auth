...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _vm.status == "loading"
        ? _c("div", { staticClass: "justify-center items-center" }, [
            _c("p", [_vm._v("Loading...")])
          ])
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "py-6 px-6 shadow-md mb-8 bg-white" }, [
          ...
          _c(
            ...
            [
              _c(
                "router-link",
                {
                  staticClass: "text-gray-800 hover:text-gray-600 font-light",
                  attrs: { to: "/register" }
                },
                [_vm._v("\n\t\t\t\t\t\tRegister\n\t\t\t\t\t")]
              )
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "brand" }, [
      _c("h1", { staticClass: "text-lg font-light text-gray-800" }, [
        _vm._v("Laravel Vuex Auth")
      ])
    ])
  }
]
...
var Register = function Register() {
  return __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(null, /*! ./pages/Register.vue */ "./resources/js/pages/Register.vue"));
};

var Login = function Login() {
  return __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.bind(null, /*! ./pages/Login.vue */ "./resources/js/pages/Login.vue"));
};

var NotFound = function NotFound() {
  return __webpack_require__.e(/*! import() */ 2).then(__webpack_require__.bind(null, /*! ./pages/NotFound.vue */ "./resources/js/pages/NotFound.vue"));
};
...
var ifNotAuth = function ifNotAuth(to, from, next) {
  ...
  if (!_store_store__WEBPACK_IMPORTED_MODULE_0__["store"].getters.isLoggedIn) {
...
var store = new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  ...
  getters: {
    ...
    //true jika terdapat token (state token nya gk NOT)
    authStatus: function authStatus(state) {
      return state.status;
    }
  },
  mutations: {
    authRequestMutation: function authRequestMutation(state, token) {
      state.status = 'loading';
    },
    authSuccessMutation: function authSuccessMutation(state, token) {
      state.status = 'success';
      state.token = token;
    },
    authErrorMutation: function authErrorMutation(state) {
      state.status = 'error';
    },
    authLogoutMutation: function authLogoutMutation(state) {
      state.status = '';
      state.token = '';
    }
  },
  actions: {
    ...
    logout: function logout(context, user) {
      return new Promise(function (resolve, reject) {
...
__webpack_require__(/*! /media/dodypras/4836F54136F53094/Coding Stuff/Laravel Projects/vuex-laravel-auth/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /media/dodypras/4836F54136F53094/Coding Stuff/Laravel Projects/vuex-laravel-auth/resources/css/app.css */"./resources/css/app.css");
